> Historical audit at commit `085cd1b`, superseded by [the current grading policy](anchor_grading.md).
> To reproduce the old figures, use that commit's plotting script. The current script shows the new policy.
